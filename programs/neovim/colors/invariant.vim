" Vendored from https://github.com/andrebrait/invariant-colors (EPL-2.0),
" file colors/invariant.vim. Kept verbatim; every change this repo makes lives
" in lua/plugins/colorscheme.lua so the upstream file stays easy to re-sync.
"
